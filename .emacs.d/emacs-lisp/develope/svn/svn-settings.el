...
(eal-define-keys-commonly
 global-map
 `(("C-x v s" svn-status)
   ("C-x v a" svn-add-current-file)
   ("C-x v c" svn-status-commit)
   ("C-x v d" svn-rm-current-file)
   ("C-x v r" svn-revert-current-file)
   ("C-x v u" svn-update-current-file)
...
(eal-define-keys
 ...
 `(("C-x v L" svn-status-show-svn-log)))
