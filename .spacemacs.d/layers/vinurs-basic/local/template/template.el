...
(defcustom template-header-lines 4
...
(defvar template-default-expansion-alist
  '(("POINT" (setq template-point (point-marker))) ; point
    ...
    ("VC_DATE" (set-time-zone-rule "UTC-8")
	...
	("MONTH" (template-insert-time "%m" "00"))
	("DAY" (template-insert-time "%d" "00"))
	("HOUR" (template-insert-time "%H" "00"))
	("MINUTE" (template-insert-time "%M" "00"))
	("SECOND" (template-insert-time "%S" "00"))
...
The default predefined expansion forms are --default is inserting--:
  ...
  (>>>DAY<<<)		  the day:01
  (>>>HOUR<<<)		  the hour:01
  (>>>MINUTE<<<)	  the minute:01
  (>>>SECOND<<<)  	  the second:01
