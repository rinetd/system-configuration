...
-l110 /*  ********************非注释行最长多少，感觉暂时没必要指定，后来实验了一下这里暂时用86个来进行,因为我的emacs的分屏以后差不多一屏长度为86*/
