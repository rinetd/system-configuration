      ...
      (if (eq src 'horiz)
          (if (eq dest 'opposite)
            ...
            (if (or (eq (window-get w 'type) 'default)
                ...
                (setq framehigh (+ (- styletab-c:title-dimension (* (borders-dimension) 2)) framew))
        ...
        (if (eq dest 'opposite)
          ...
          (if (or (eq (window-get w 'type) 'default)
                  (eq (window-get w 'type) 'transient))
              (setq framehigh (- styletab-c:title-dimension (* (borders-dimension) 2)))
  ...
  (let ((w (current-event-window))
    ...
    (when (eq dest 'def-tra)
      ...
      (when (or (eq cur 'shaped)
                (eq cur 'utility))
        (setq new 'default)
        (setq dim-x (- dim-x (* (borders-dimension) 2)))
        (setq dim-y (- dim-y (borders-dimension)))
        (when (not (or (eq current-title 'top)
                       (eq current-title 'bottom)))
          (setq dim-x (+ dim-x (borders-dimension)))
          (setq dim-y (- dim-y (borders-dimension)))))
      ...
      (when (eq cur 'unframed)
        ...
        (when (or (eq current-title 'top)
                  (eq current-title 'bottom))
          (setq dim-x (- dim-x (* (borders-dimension) 2)))
          (setq dim-y (- dim-y (borders-dimension) styletab-c:title-dimension)))
        (when (not (or (eq current-title 'top)
                       (eq current-title 'bottom)))
          (setq dim-y (- dim-y (* (borders-dimension) 2)))
          (setq dim-x (- dim-x (borders-dimension) styletab-c:title-dimension)))))
...
(define (window-icon w)
  (or (table-ref styletab-c-icon-cache w)
      (let ((icon (window-icon-image w)))
        (if icon
            (let ((scaled (scale-image icon (- styletab-c:title-dimension 9) (- styletab-c:title-dimension 9))))
              (table-set styletab-c-icon-cache w scaled)
              scaled)
          (scale-image top-frame-icon-title-images (- styletab-c:title-dimension 9) (- styletab-c:title-dimension 9))))))
...
(defun borders-dimension (w)
	(if (window-maximized-p w) 0 6))
...
(define title-height-s (lambda (w) (- styletab-c:title-dimension 2))) ;;;aaaaaaaaa
  ...
  `(((class . top-left-corner)
    ...
    ((class . top-left-corner)
     ...
     (width . ,(lambda (w) (if (or (eq (window-get w 'type) 'shaped) 
                                   (eq (window-get w 'type) 'shaped-transient))
                               (borders-dimension)
                             (if (window-get w 'shaded) (borders-dimension) sharped-edge)))))
    ((class . top-right-corner)
     (background . ,(lambda (w) (if (window-get w 'shaded) 
...
(define (make-buttons)
  ...
  (let* (;; turns one cons cell (btn-name . show-in-transients) into a button
         ...
         (top-normal-buttons-left
          (make-button-list nil styletab-c:top-left-buttons 'left-edge (+ (button-left-edge) (borders-dimension-2)) 
         ...
         (top-normal-buttons-right
          (make-button-list nil styletab-c:top-right-buttons 'right-edge (+ (button-right-edge) (borders-dimension-2)) 
                            (+ styletab-c:title-dimension (button-width-custom))))
         ...
         (top-transient-buttons-left
          (make-button-list t styletab-c:top-left-buttons 'left-edge (+ (button-left-edge) (borders-dimension-2))
                            (+ styletab-c:title-dimension (button-width-custom))))
         ...
         (top-transient-buttons-right
          (make-button-list t styletab-c:top-right-buttons 'right-edge (+ (button-right-edge) (borders-dimension-2))
                            (+ styletab-c:title-dimension (button-width-custom))))
         ...
         (bottom-normal-buttons-left
          (make-button-list nil styletab-c:bottom-left-buttons 'left-edge (+ (button-left-edge) (borders-dimension-2)) 
                            (+ styletab-c:title-dimension (button-width-custom))))
         ...
         (bottom-normal-buttons-right
          (make-button-list nil styletab-c:bottom-right-buttons 'right-edge (+ (button-right-edge) (borders-dimension-2)) 
                            (+ styletab-c:title-dimension (button-width-custom))))
         ...
         (bottom-transient-buttons-left
          (make-button-list t styletab-c:bottom-left-buttons 'left-edge (+ (button-left-edge) (borders-dimension-2))
                            (+ styletab-c:title-dimension (button-width-custom))))
         ...
         (bottom-transient-buttons-right
          (make-button-list t styletab-c:bottom-right-buttons 'right-edge (+ (button-right-edge) (borders-dimension-2))
                            (+ styletab-c:title-dimension (button-width-custom))))
         ...
         (left-normal-buttons-top
          (make-button-list nil styletab-c:left-top-buttons 'top-edge (+ (button-right-edge) (borders-dimension-2)) 
                            (+ styletab-c:title-dimension (button-width-custom))))
         ...
         (left-normal-buttons-bottom 
          (make-button-list nil styletab-c:left-bottom-buttons 'bottom-edge (+ (button-left-edge) (borders-dimension-2)) 
                            (+ styletab-c:title-dimension (button-width-custom))))
         ...
         (left-transient-buttons-top
          (make-button-list t styletab-c:left-top-buttons 'top-edge (+ (button-right-edge) (borders-dimension-2)) 
                            (+ styletab-c:title-dimension (button-width-custom))))
         ...
         (left-transient-buttons-bottom
          (make-button-list t styletab-c:left-bottom-buttons 'bottom-edge (+ (button-left-edge) (borders-dimension-2)) 
                            (+ styletab-c:title-dimension (button-width-custom))))
         ...
         (right-normal-buttons-top
          (make-button-list nil styletab-c:right-top-buttons 'top-edge (+ (button-left-edge) (borders-dimension-2)) 
                            (+ styletab-c:title-dimension (button-width-custom))))
         ...
         (right-normal-buttons-bottom 
          (make-button-list nil styletab-c:right-bottom-buttons 'bottom-edge (+ (button-right-edge) (borders-dimension-2)) 
                            (+ styletab-c:title-dimension (button-width-custom))))
         ...
         (right-transient-buttons-top
          (make-button-list t styletab-c:right-top-buttons 'top-edge (+ (button-left-edge) (borders-dimension-2))
                            (+ styletab-c:title-dimension (button-width-custom))))
         ...
         (right-transient-buttons-bottom
          (make-button-list t styletab-c:right-bottom-buttons 'bottom-edge (+ (button-right-edge) (borders-dimension-2)) 
                            (+ styletab-c:title-dimension (button-width-custom))))
